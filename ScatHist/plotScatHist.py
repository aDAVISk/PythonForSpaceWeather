...
def scatHist(x,y, # data for plotting
      ...
      xlim=None,ylim=None,bins=None,saveName=None,
  ...
  # Adjestment for the scatter plot
	...
	axScatter.grid()
	axScatter.set_xlabel(xTitle)#,fontsize=fontsize)
	axScatter.set_ylabel(yTitle)#,fontsize=fontsize)
  ...
  # Adjestment for histgram of x
	...
	axHistX.grid(axis="x")
	axHistX.set_ylabel("counts")#,fontsize=fontsize)
  ...
  # Adjestment for histgram of y
	...
	axHistY.set_xlabel("counts")#,fontsize=fontsize)
	axHistY.grid(axis="y")
